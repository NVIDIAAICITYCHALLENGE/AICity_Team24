...
def parse_args():
    ...
    parser.add_argument('--model', dest='model_name',
                        ...
                        default=None, type=str)
    parser.add_argument('--signal', help='whether to train on signal data',
                        default=0, type=int)
    parser.add_argument('--rpn_model', dest='rpn_model',
                        default=None, type=str)
...
if __name__ == '__main__':
    ...
    mp_kwargs = dict(
        ...
        rpn_model_path=str(args.rpn_model),
        cfg=cfg,
